...
CONFIG <- list(
  ...
  output_dir = "results",                      # Répertoire de sortie des CSV et graphiques
...
run_analysis <- function(config = CONFIG) {
  ...
  # Note : les données détaillées par site (courbe temps-espèces, TEE/IR, fréquences, occupation spatiale) sont déjà sauvegardées dans les sous-dossiers respectifs de chaque site.
